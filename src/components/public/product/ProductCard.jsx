...
//       <Link href={`/products/${product?.slug || id}`} className="relative block aspect-square bg-gray-100">
//         <Image
//           src={image}
...
//           <Link href={`/products/${product?.slug || id}`} className="line-clamp-2 text-sm font-medium">
//             {product?.name}
//           </Link>
